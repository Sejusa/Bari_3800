...
void program_movement(char instruction) //Función para programar el movimiento, 'instruction' es el valor del botón.
{
  switch(instruction)
  {
    case button_forward:
